...
plot_output('embed/output_stream0')
plot_output('embed/output_stream5')
plot_output('embed/output_stream10')
plot_output('embed/output_stream15')
plot_output('embed/output_stream20')
plot_output('embed/output_stream25')
plot_output('embed/output_stream30')
plot_output('embed/output_stream34')
